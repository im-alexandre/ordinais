...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        deleteText: 'Remover',            // Text for the delete link
        addContainerClass: null,         // Container CSS class for the add link
        deleteContainerClass: null,      // Container CSS class for the delete link
        addCssClass: 'md-3 btn btn-primary add-row mb-3 mt-3',          // CSS class applied to the add link
        deleteCssClass: 'btn btn-danger delete-row ml-5',    // CSS class applied to the delete link
